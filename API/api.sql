...
--
-- Dumpning av Data i tabell `authors_books`
--
...
INSERT INTO `books` (`id`, `title`, `isbn`, `description`) VALUES
...
--
-- Dumpning av Data i tabell `books_genres`
--
...
--
-- Restriktioner för tabell `authors_books`
--
ALTER TABLE `authors_books`
  ADD CONSTRAINT `authors_books_author` FOREIGN KEY (`author_id`) REFERENCES `authors` (`id`),
  ADD CONSTRAINT `authors_books_book` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`);

--
-- Restriktioner för tabell `books_genres`
--
ALTER TABLE `books_genres`
  ADD CONSTRAINT `books_genres_book` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`),
  ADD CONSTRAINT `books_genres_genre` FOREIGN KEY (`genre_id`) REFERENCES `genres` (`id`);
COMMIT;
